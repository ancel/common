	...
	public static void main(String[] args) {
		try {
			...
			while ((s = in.readLine()) != null) {
				...
				Class<? extends AbstractAction> myClass = (Class<? extends AbstractAction>) myClassLoader.loadClass("com.work.common.demo.classloader.TestAction");
			...
			URLClassLoader myClassLoader1 = new URLClassLoader(new URL[] { url1 }, Thread.currentThread()
					.getContextClassLoader());
			Class<?> myClass1 = myClassLoader1.loadClass("com.work.common.demo.classloader.TestAction");
