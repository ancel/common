...
import com.work.common.enums.LocalThreadPool;
/**
...
public class ThreadPool {
	...
	public static ThreadPool getThreadPool(){
		...
		LocalThreadPool.FIXED.setnThreads(pool.threadLimit);
		pool.executorService = LocalThreadPool.FIXED.getThreadPool(); 
		return pool;
	}
